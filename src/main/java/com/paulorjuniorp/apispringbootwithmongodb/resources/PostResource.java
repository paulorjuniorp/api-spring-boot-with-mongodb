...
import com.paulorjuniorp.apispringbootwithmongodb.resources.util.URL;
import com.paulorjuniorp.apispringbootwithmongodb.services.PostService;
...
public class PostResource {
	...
	public ResponseEntity<List<Post>> searchTitle(@RequestParam(value="text", defaultValue = "") String text){
		text = URL.decodeParam(text);
		List<Post> obj = postService.searchTitle(text);
